...
const exclusions = [
  [
    ...
    "Aucun SIREN vérifiable rattaché de façon certaine à la structure.",
  ],
  [
    "Activité incompatible",
    "Aucune offre de prestation IA ne peut être rattachée à la structure.",
  ],
  [
    "Pas d'offre IA réelle",
    "Le site ne présente pas d'offre IA identifiable, seulement une mention.",
  ],
  [
    "Nature différente",
    "École, média, comparateur, organisme public : ce ne sont pas des prestataires.",
  ],
  [
    "Données non diffusibles",
    "Les données du registre ne sont pas publiées. Une fiche commerciale demandée par le prestataire reste distincte d'une identité publique vérifiée.",
  ],
];
...
const faqs: FaqItem[] = [
  {
    question:
      "Un prestataire peut-il payer pour être référencé ou mieux placé ?",
    answer:
      "Le référencement de base est gratuit. L’annuaire est classé par ordre alphabétique. Aucune position ni recommandation n’est vendue. Aucune offre payante n’est proposée actuellement.",
  },
  {
  ...
  {
    question:
      "Ma structure est référencée sans que je l'aie demandé. Que faire ?",
    answer:
  ...
  return (
    <>
      <div className="page-shell">
        <Breadcrumbs
          items={[{ label: "Méthodologie", href: "/methodologie" }]}
        />
        <div className="mt-8 max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-muted">
            Un annuaire ne vaut que par ce qu'il a vérifié. Cette page décrit
            exactement d'où viennent les données, ce que nous contrôlons, ce que
            nous refusons de publier et où passe la frontière commerciale.
          </p>
        </div>
      </div>
      ...
      <section className="border-y border-line bg-soft">
        <div className="section">
          <div className="section-heading">
            ...
            <p>
              Chaque exclusion est motivée. Une fiche en moins vaut mieux qu'une
              donnée fausse.
            </p>
          </div>
      ...
      <section className="section">
        ...
        <div className="max-w-3xl space-y-4 text-base leading-7 text-muted">
          <p>
            La fiche de base est{" "}
            <strong className="text-ink">gratuite et le restera</strong>. Aucun
            prestataire ne peut acheter sa position ou une recommandation.
          </p>
          <p>
            Le référencement et le dépôt de demande sont gratuits. Aucune offre
            premium ni commission n’est activée actuellement. Toute évolution
            commerciale sera expliquée clairement avant d’être proposée.
          </p>
          <p>
            Les données déclaratives (ce que le prestataire dit de lui) sont
            distinguées des données vérifiées (ce que nous avons contrôlé à la
            source). Les fiches indiquent l'origine de chaque bloc et sa date de
            contrôle.
          </p>
          <p>

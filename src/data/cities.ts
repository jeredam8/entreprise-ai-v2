...
const defaultFaqs = (city: string) => [
  ...
  },
  {
    ...
    answer:
      "Le formulaire de dépôt permet de décrire le besoin, le budget, les outils existants et les contraintes pour préparer une sélection de prestataires adaptés.",
  },
];
...
export const cities: CityPage[] = [
  ...
  },
  {
    ...
    intro:
      "Bordeaux est pertinent pour des projets IA autour de la documentation, des services, de l'e-commerce et de l'automatisation. La sélection doit rester fondée sur les compétences vérifiables.",

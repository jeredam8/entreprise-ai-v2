...
const columns = [
  {
    ...
    links: [
      ...
      {
        label: "Référencer un prestataire",
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 lg:grid-cols-[1.3fr_2fr] lg:px-8">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-6 text-slate-300">
            L’annuaire des prestataires IA en France. Comparez les offres,
            décrivez votre projet ou référencez gratuitement votre activité.
          </p>
        </div>
